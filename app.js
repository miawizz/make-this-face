...
(() => {
  ...
  const PROMPTS = [
    ...
    { t: "You just looked in the mirror and realized you’ve had spaghetti sauce all over your face" },
    ...
    { t: "You are about to blow out all the candles on your birthday cake and you realllly want your wish to come true this year" },
    ...
    { t: "400 pigeons just swooped down and flew all around you then flew away again" },
    { t: "You're watching TV and suddenly you see someone on the screen that looks EXACTLY like you!" },
    { t: "You just bit into a piece of lemon pie and realized whoever cooked it forgot the sugar and it's SOUR" },
    { t: "You just smelled the most amazing smell like fresh baked muffins but then realized it's coming from your own armpit??" },
    { t: "The cutest little puppy dog just walked up to you and licked your toes" },
    { t: "A crow just landed on your shoulder and CAWED right in your ear" },
    { t: "A cow just rang your doorbell with its nose and is now mooing you a singing telegram" },
    { t: "You're wearing your favorite pair of socks and then you just stepped in a puddle of water someone spilled" },
    { t: "You just got a mystery package in the mail and you're about to open it but then you hear weird grumbling noises coming from inside the box" },
    { t: "You had a dream that all your teeth fell out and you wake up checking to make sure they're still there" },
    { t: "You're SUPER sleepy and trying to stay awake while watching a movie about cheese" },
